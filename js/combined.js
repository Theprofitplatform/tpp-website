// Combined JavaScript for The Profit Platform - Optimized and Unified
// Includes: main.js, homepage.js, exit-intent.js functionality

// ========================================
// Core Utilities and Scroll Progress Bar
// ========================================
...
// Global Mobile Navigation Functions (used by multiple components)
...
function updateFAQVisibility() {
    allFaqs.forEach((faq, index) => {
        const shouldShow = filteredFaqs.includes(faq) && filteredFaqs.indexOf(faq) < visibleFaqs;
